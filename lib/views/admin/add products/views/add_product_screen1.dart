...
class _AddProductState extends State<AddProduct> {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormProduct(
                  maxline: 1,
                  label: "اسم المنتج",
                  width: 300, controller: nameController,
                ),
                ...
                TextFormProduct(
                  ...
                  maxline: 2,
                  label: "الوصف",
                  width: 300, controller: priceController,
                ),
                ...
                CustomButton(
                 ...
                 SizedBox(height: 10,),
                 GestureDetector(onTap: ()=>Navigator.pop(context),child: Text("رجوع",style: ConstantStayles.style1,)),
              ],
            ),
          ),
        ),
  ...
  final product = ProductModel(
    ...
    options: null,
    imageUrl: "",
    category: Category(3, "Sample Category", "https://example.com/category.jpg"),
